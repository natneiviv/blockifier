...
private:
   ...
   */
   ...
   void renderLeaf(Node* n, PNG & image);
   // returns the number of leaves that are within the tol
   double tolHelper(Node* compare, Node* curr, int tol);
   // recursive helper to clear function
   void clearHelper(Node* n);
   // returns the number of leaf nodes
   double numLeaves(Node* n);
   // recursive helper to prune function
   void pruneHelper(Node* n, double pct, int tol);
